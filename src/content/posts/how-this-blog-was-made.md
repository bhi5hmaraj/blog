...
description: The influences behind this site.
date: 2026-08-16
tags:
  - tech
  - ai-assisted
draft: false
---
This version replaces my older Jekyll blog and the Bookstack version with a small static site built on [Astro](https://astro.build/). 

The visual direction is inspired by [Tufte CSS](https://edwardtufte.github.io/tufte-css/): .[1](#note-et-book)

**1.** The typeface is ET Book, served locally from the Tufte CSS project.
